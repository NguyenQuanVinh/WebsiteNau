...
<div class="container-fluid mb-5 mt-5" 
    style="background-image: url(../image/banner3.png); 
...
<div class="container">
    <div class="row">
        <div class="col-lg-2">
            ...
            <div class="border-bottom pb-3">
                <a class="btn btn-success mt-2" href="new-product.php">New Product</a>
            </div>
        </div>
        <div class="col-lg-10">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-3 mb-4">
                        ...
                        <div class="ps-2 pe-2">
                            ...
                            <a class="float-end text-danger" href="delete-product.php?id=<?= $product->id ?>" style="text-decoration: none;">Delete</a>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
